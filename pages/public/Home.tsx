...
const Home = () => {
  ...
  // Dynamically select the newest post as featured
        ...
        {loading ? (
          <div className="text-center py-20 text-slate-400">Loading articles...</div>
           ...
           <div className="text-center py-20">
              ...
              <h3 className="text-lg font-medium text-primary">Unable to load content</h3>
              <p className="text-secondary mt-1">Please check your connection or configuration.</p>
           </div>
        ) : (
          <>
